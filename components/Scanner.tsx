...
const Scanner: React.FC<ScannerProps> = ({
  ...
  useEffect(() => {
    ...
    const setColor = (name: string, value: [number, number, number]) => {
      const uniform = u[name];
    ...
    setNumber("uSpeed", speed);
    setNumber("uSweepSpeed", sweepSpeed);
    setNumber("uSweepWidth", sweepWidth);
    setNumber("uSweepFalloff", sweepFalloff);
    setNumber("uScale", scale);
    setNumber("uFrequency", frequency);
    setNumber("uRipple", ripple);
    setNumber("uBandDensity", bandDensity);
    setNumber("uLineSharpness", lineSharpness);
    setNumber("uGlow", glow);
    setNumber("uColorSpread", colorSpread);
    setNumber("uBrightness", brightness);
    setNumber("uContrast", contrast);
    setNumber("uSoftness", softness);
    setNumber("uVignette", vignette);
    setNumber("uOpacity", opacity);
    setNumber("uScanline", scanline ? 1.0 : 0.0);
    setNumber("uGrain", grain ? 1.0 : 0.0);
    setNumber("uGrainIntensity", grainIntensity);
    setNumber("uDirection", directionToFloat(scanDirection));
    setNumber("uMouseEnabled", mouseInteraction ? 1.0 : 0.0);
    setNumber("uMouseRadius", mouseRadius);
    setNumber("uMouseStrength", mouseStrength);
